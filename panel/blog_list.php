	...
	<div class="row">
		<div class="col-md-12">
			...
			<?php
				...
				?>
				<form name="icerikForm" action="blog_list.php" method="post">
				<header class="card-header">
					<div class="card-actions">
						...
						<a rel="tooltip" data-placement="bottom" data-toggle="tooltip" title="Yeni Blog Ekle"  href="blog_ekle.php" class="fa fa-plus"></a>
						<a href="#" class="fa fa-caret-down"></a>
						<a href="#" class="fa fa-times"></a>
					</div>
					<h2 class="card-title">Blog Listesi</h2>
							...
							<table class="table table-striped mb-none">
								...
								<tbody>
									...
									<tr>
										...
										<td align="right">
											<a data-placement="top" data-toggle="tooltip" title="Blog Güncelle" href="blog_edit.php?id=<?php echo $value['id']; ?>" class="mb-1 mt-1 mr-1 btn btn-info"><i class="fa fa-edit"></i></a>
										</td>	
										<td align="right">
											<a data-placement="top" data-toggle="tooltip" title="Blog Sil" onclick="return confirm('Silmek istediğinize emin misiniz?')" class="mb-1 mt-1 mr-1 btn btn-danger" href="blog_del.php?id=<?php echo $value['id']; ?>"><i class="fa fa-trash-o"></i></a>
										</td>	
									</tr>
									<?php } ?>
								</tbody>
