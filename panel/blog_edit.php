	...
	<section class="card card-featured card-featured-primary">
			...
			if($_POST['baslik'])
			{
				...
				if($_FILES["banner"]["name"]) {
					...
					if(($banner <> "") && ($typeResult=="A")) {
						...
						move_uploaded_file($_FILES["banner"]["tmp_name"],SITE_ROOT."/../dosyalar/images/blog/".$banner);
						$banner="/dosyalar/images/blog/".$banner;
						$data = Array (
							'banner' => $banner,
						);
						$db->where ('id', $eski_id);
		...
		<div class="row">
			<div class="col-md-12">
						...
						<form action="blog_edit.php?id=<?=$eski_id?>" method="post" class="form-horizontal form-bordered" enctype="multipart/form-data">
