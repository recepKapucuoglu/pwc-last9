							...
							<div class="row">
								<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
									<center>
										...
										<h3><b style="color:#ffb600">Kayıt Tamamlandı</b></h3>
										<h3><strong>Kayıt Numarası: <?php echo $siparis_id; ?></strong></h3>
										<h3><br/><strong>Kaydınız tarafımıza ulaşmıştır. Eğitim katılım linki ve ödeme bilgileri eğitim tarihinden 1 gün önce katılımcıya e-mail olarak iletilecektir.</strong></h3>
									</center>
