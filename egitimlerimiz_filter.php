...
if (isset($searchTerm) && !isset($gelenVeri) && !isset($gelenCategory)&& !isset($gelenLocation)) {
   if($_POST['isElearningEgitimleri']){
   $query = "SELECT * FROM egitimlerimiz_filter where egitim_adi LIKE '%$searchTerm%' AND types = 'E-Learning' ";}
   else {
