        ...
        <div class="rbt-course-details-area">
            <div class="egitim-detay_bread">
                <div class="container">
                    ...
                    <h2 style="font-size:30px"><?php echo $egitim_adi; ?></h2>
                </div>
            </div>
                            ...
                            <div class="egitim-detay_section">
                                ...
                                <div class="egitim-detay_desc">
                                    <div class="egitim-detay_text">
                                        Kişisel Verilerin Konunması Mevzuatına Uygum için Neler Yapılmalı?
                                    </div>
                                    <div class="egitim-detay_button">
                                        Eğitime Git
                                    </div>
                                </div>
                ...
                <div class="container">
                    <div class="left-side-egitim" style="display:flex; justify-content:space-between; ">
                        <div class="egitim-icerigi_text">
                            ...
                            <p>
                                Eğitimimiz Cisco Webex üzerinden online olarak gerçekleştirilecektir.
                            </p>
